...
const { PanelBody, Path, SVG, ToggleControl } = wp.components;
...
registerBlockType( 'editorial/listicle', {
	...
	edit: class extends Component {
		...
		componentDidUpdate( prevProps ) {
			...
			const { credit, backgroundCaption } = attributes;

			// Stop here if the `backgroundCaption` attribute hasn't changed.
			if (
				backgroundCaption === prevProps.attributes.backgroundCaption
			) {
				return;
			}
		...
		render() {
			...
			const { attributes, setAttributes, className, isSelected } =
				this.props;
					...
					<article className="wp-block-editorial-listicle-article">
						...
						<section className="wp-block-editorial-listicle-section">
							...
							<div className="wp-block-editorial-listicle-section-meta">
								...
								<ShareTools blockProps={ this.props } />
							</div>
						</section>
