 ...
 * @return {?ReactNode | false} Block appender, if less than the maximum number of inner blocks, or otherwise false.
 */
export default function useRenderAppenderWithBlockLimit(
	clientId,
	blockLimit,
	appender
) {
